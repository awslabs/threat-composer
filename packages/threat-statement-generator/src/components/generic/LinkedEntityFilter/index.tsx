      ...
      options={[
        {
          ...
          iconSvg: (<Tooltip tooltip={`Show threats Without linked ${entityDisplayName}`}>
            <svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="LinkOffIcon">
        ...
        },
        {
          ...
          iconSvg: (<Tooltip tooltip='Show all threats'>
            <svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="AllInclusiveIcon">
        ...
        },
        {
          ...
          iconSvg: (<Tooltip tooltip={`Show threats With linked ${entityDisplayName}`}>
            <svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="LinkIcon">
