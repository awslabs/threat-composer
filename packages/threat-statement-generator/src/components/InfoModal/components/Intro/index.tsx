...
const InfoModalIntro: FC = () => {
  return (<InfoModalBase title='threat-composer'>
    <p>This tool has <span className='threat-statement-editor-info-model-content-highlight'>a singular focus on the <i>“What can go wrong?”</i> threat modeling step</span>, with the aim of making it faster and easier for you to:</p>
