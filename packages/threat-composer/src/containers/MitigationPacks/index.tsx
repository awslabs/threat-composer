...
import MitigationPacksComponent from '../../components/workspaces/MitigationPacks';
...
const MitigationPacks: FC<MitigationPacksProps> = ({ workspaceId }) => {
  return (<WorkspaceContextAggregator
    requiredGlobalSetupContext
    workspaceId={workspaceId || null}
    composerMode='Full'
  >
    <MitigationPacksComponent />
