...
const InfoModalFeatures: FC = () => {
  return (<InfoModalBase title={<>Features</>}>
    <div className='threat-statement-generator-info-modal-feature-sets'>
      <div className='threat-statement-generator-info-modal-feature-set threat-statement-generator-info-modal-feature-set-2-per-row'>
        ...
        <div>Renders <span className='threat-statement-editor-info-model-content-highlight'>structured threat statements</span> based on user input</div>
      </div>
      <div className='threat-statement-generator-info-modal-feature-set threat-statement-generator-info-modal-feature-set-2-per-row'>
        ...
        <div><span className='threat-statement-editor-info-model-content-highlight'>Adaptive threat statement structure</span> to support progressively more complete user input</div>
      </div>
      <div className='threat-statement-generator-info-modal-feature-set threat-statement-generator-info-modal-feature-set-2-per-row'>
        ...
        <div><span className='threat-statement-editor-info-model-content-highlight'>Dynamic suggestions</span> based on supplied and missing user input</div>
      </div>
      <div className='threat-statement-generator-info-modal-feature-set threat-statement-generator-info-modal-feature-set-2-per-row'>
        ...
        <div>Complete threat statement <span className='threat-statement-editor-info-model-content-highlight'>examples to aid contextual brainstorming</span> and re-use</div>
      </div>
    </div>
  </InfoModalBase>);
};
