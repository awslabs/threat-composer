...
const LinkedEntityFilter: FC<LinkedEntityFilterProps> = ({
  ...
  return (<div css={styles.root}>
    ...
    <SegmentedControl
      ...
      options={[
        {
          iconAlt: `${t('Without linked')} ${entityDisplayName}`,
          id: WITHOUT_NO_LINKED_ENTITY,
          iconSvg: (<Tooltip tooltip={`${t('Show threats without linked')} ${entityDisplayName}`}>
        ...
        },
        {
          iconAlt: t('All'),
          id: ALL,
          iconSvg: (<Tooltip tooltip={t('Show all threats')}>
        ...
        {
          iconAlt: `${t('With')} ${entityDisplayName}`,
          id: WITH_LINKED_ENTITY,
          iconSvg: (<Tooltip tooltip={`${t('Show threats with linked')} ${entityDisplayName}`}>
