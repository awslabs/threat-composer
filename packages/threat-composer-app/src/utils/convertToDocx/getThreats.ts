 ...
 ******************************************************************************************************************** */
import type { AssumptionLink, DataExchangeFormat, MitigationLink, TemplateThreatStatement } from '@aws/threat-composer';
import { standardizeNumericId, threatStatus, STATUS_NOT_SET } from '@aws/threat-composer';
