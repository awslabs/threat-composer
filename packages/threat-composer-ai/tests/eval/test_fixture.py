...
No strands-agents-evals import here, so these run whether or not the eval extra is
installed.
"""
...
from threat_composer_ai.eval.fixture import EXCLUDED_DIRS, identify, verify
...
class TestRecordedPinMatchesTheFixture:
    ...
    def test_hashed_files_match_what_git_tracks(self):
        ...
        assert not missed, (
            ...
            f"Remove the containing directory from EXCLUDED_DIRS ({sorted(EXCLUDED_DIRS)})."
        )
